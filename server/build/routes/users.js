...
exports.userRoute.post('/createuser', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            ...
            bcrypt_1.default.hash(req.body.password, 10, function (err, hash) {
                return __awaiter(this, void 0, void 0, function () {
                    var users, secret, token, err_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                users = new Users_1.default({
                            ...
                            case 2:
                                ...
                                token = jsonwebtoken_1.default.sign({ _id: users._id }, secret);
                                res.status(200).send({
                                    token: token,
...
exports.userRoute.get('/getdata', verify_1.verifyUser, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var token;
    return __generator(this, function (_a) {
        token = req.token;
